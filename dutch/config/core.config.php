...
$core_config['php']['session_name'] = "PHPSESSIDDUTCH6723";
...
$core_config['release']['release_date'] = 				"23-18-2008"; // MM-DD-YYYY
...
$core_config['db']['pass'] = "";
$core_config['db']['db'] = "barnraiser_dutch";
$core_config['db']['prefix'] =	 						"dutch";
...
// URI, DOMAIN CONFIGURATION -----------------------------
$core_config['script']['core_domain'] = "dutch.localhost";


// SECURITY CONFIGURATION -----------------------------------------------
// we can access the maintainer.php page? Enter the users openid_name
$core_config['security']['maintainer_userids'] = "0";


// THEME CONFIGURATION --------------------------------------------------
$core_config['script']['theme_name'] = 		"silver";
...
// NOTIFICATION TYPES ---------------------------------------
$core_config['script']['notification_type']['join_network'] = 			1; // join network
$core_config['script']['notification_type']['create_network'] = 		2; // start network
