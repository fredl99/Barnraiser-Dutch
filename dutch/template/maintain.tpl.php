...
<div id="col_single">
	<div class="box" id="box_accounts">
		...
		<div class="box_body">
			...
			?>
			<li>
				<span class="user_id"><a href="/maintain/account/<?php echo $i['user_id'];?>"><?php echo $i['user_id'];?></a></span>
...
<div id="col_left">
	...
	<div class="box">
		...
		<div class="box_body">
			<p>
				<?php echo _("A 'Maintainer' is an administrator that has access to this screen. Add a maintainers UserID. Use a comma to separate each ID.");?>
			</p>
			
			<p>
				<label for="id_maintainer_userids"><?php echo _("UserIDs");?></label>
				<input type="text" name="maintainer_userids" id="id_maintainer_userids" value="<?php echo $arr_security['maintainer_userids'];?>" />
			</p>
			
			<p class="buttons">
				<input type="submit" name="save_config_maintainer_userids" value="<?php echo _("save");?>" />
			</p>
		</div>
	</div>
</div>
