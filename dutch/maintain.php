...
elseif (isset($_POST['save_config_maintainer_userids'])) {

	backupConfig();
	
	$core_config['security']['maintainer_userids'] = $_POST['maintainer_userids'];

	writeToConfig('$core_config[\'security\'][\'maintainer_userids\']', $core_config['security']['maintainer_userids']);
}
...
if (isset($uri_routing[1]) && $uri_routing[1] == "account" && isset($uri_routing[2])) {
	...
	$query = "
		SELECT user_id, user_name, user_email, user_dob, user_live 
		FROM " . $db->prefix . "_user 
		WHERE 
